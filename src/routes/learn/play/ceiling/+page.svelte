<script lang="ts">
  ...
  let verdict = $derived.by(() => {
    if (coreState === "loading")
      return "Loading the module. Nothing is decided yet.";
    if (coreState === "failed")
      return "The decision module could not be loaded.";
    if (blocked === "empty")
...
<Board
  ...
  sentence="Three parties decide what an application may do. The manifest asks, the owner of the installation may replace that request outright, and the administrator's ceiling narrows whatever survived. Change any of the three and read what runs."
  reference={{ href: "/docs/managed-deployment", label: "Managed deployment" }}
  phase={coreState}
...
>
  ...
  <div class="mt-6 grid items-start gap-6 lg:grid-cols-12">
    <section aria-labelledby="inputs" class="min-w-0 lg:col-span-5">
      ...
      <div class="rounded-2xl border border-slate-200 bg-white p-4">
        ...
        <p class="mt-3 text-sm leading-6 text-gray-600">
          {worked
            ? worked.lesson
            : "Your own case. Every answer beside it comes from the module, and nothing you type leaves the page."}
        </p>
      </div>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-4">
          <fieldset>
            ...
            <details class="mt-3">
              ...
              <div
                role="region"
                aria-label="The host, as the module receives it"
                tabindex="0"
    ...
    <section
      ...
      class="flex min-w-0 flex-col gap-4 lg:col-span-7"
    >
      ...
      {#if coreState === "loading"}
        <div class="rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <p class="mt-4 text-sm leading-6 text-gray-500">
            The board answers nothing until cpak's own code is here and checked.
          </p>
        </div>
      {:else if coreState === "failed"}
        <div class="rounded-2xl border border-red-200 bg-red-100 p-5">
          <p class="text-sm font-semibold text-red-700">
            Nothing can be decided without the module
          </p>
          <p class="mt-1 text-sm leading-6 text-gray-600">
            The board refuses to describe cpak from memory. Try again from the
