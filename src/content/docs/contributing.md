...
The cpak runtime is available under GPL-3.0-only. Contributions accepted into the public project remain available under that license. Contributors must accept the [cpak Contributor License Agreement](https://github.com/Containerpak/cpak/blob/v2/CLA.md), which also allows Mirko Brombin to grant non-exclusive commercial licenses without removing the public GPL license.
